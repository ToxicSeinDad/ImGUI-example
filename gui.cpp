...
void gui::CreateHWindow(
	...
	void gui::ResetDevice() noexcept
	{
		...
		void gui::Render() noexcept
		{
			...
			ImGui::Checkbox("Show Chams Customizer", &EditColor);

			if (EditColor)
			{
				ImGui::ColorEdit3("Chams color", color);
			}

			ImGui::TextColored(ImVec4(1, 1, 0, 1), "Gui Design Options");
			ImGui::Checkbox("Style Editor", & Style);
			if (Style)
			{
